...
async function initSanity(args, context) {
  ...
  let showDefaultConfigPrompt = !defaultConfig; // Only allow either --project-plan or --coupon
  ...
  async function getOrCreateProject() {
    ...
    if (isUsersFirstProject || intendedCoupon) {
      (0, _debug.default)(isUsersFirstProject ? 'No projects found for user, prompting for name' : 'Using a coupon - skipping project selection');
